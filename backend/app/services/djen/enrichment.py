...
from .value_extractor import extract_process_awards
from .value_persistence import persist_djen_snapshot
...
def serialize_djen_analysis(analysis: Any) -> dict[str, Any]:
    ...
    parties = snapshot.get("partes")
    if not isinstance(parties, dict):
        parties = {
            "partes_re": [],
            "empresas_re": [],
            "empresa_re_principal": None,
        }
