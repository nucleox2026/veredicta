...
def persist_djen_snapshot(
    ...
    *,
    ...
    if isinstance(empresas, list) and empresas:
        ...
        if nomes:
            # A fonte oficial DJEN tem precedência sobre o nome inferido
            # pela IA quando o polo réu está explicitamente identificado.
            analysis.empresa_re = " / ".join(nomes)
            ...
            if len(nomes) == 1:
                ...
                # O histórico lê todas as empresas diretamente do snapshot
                # DJEN. Não fabricamos uma chave única para litisconsórcio.
